...
- **核心贡献者**: Jonathan Cameron (160条), Yu Kuai (105条), Zhang Yi (74条), 等5人
...
主要技术关键词:
fix, iio, ext, add, remove
use, net, switch, sparse, friendly
iiodeviceclaimreleasedirect, check, support, adc, bpf
...
- **核心贡献者**: ChenXiaoSong (40条), Pei Xiao (23条), Ye Liu (17条), 等5人
...
主要技术关键词:
fix, add, use, smb, remove
loongarch, move, bpf, function, smbserver
leak, error, usb, null, helper
...
- **核心贡献者**: Qianfeng Rong (129条), Xichao Zhao (81条), Liao Yuanhong (75条), 等5人
...
主要技术关键词:
use, remove, redundant, error, code
type, int, store, codes, negative
ternary, deverrprobe, simplify, fix, operators
...
- **核心贡献者**: Baolin Wang (66条), Jiapeng Chong (64条), Feng Tang (32条), 等5人
...
主要技术关键词:
remove, fix, shmem, add, duplicate
header, error, idxd, memory, dmaengine
riscv, panic, use, unused, function
...
- **核心贡献者**: Binbin Zhou (111条), Bibo Mao (74条), Tiezhu Yang (40条), 等5人
...
主要技术关键词:
loongarch, use, mmc, add, kvm
devmmmcallochost, helper, drop, support, loongson
sdhcipltfmfree, loongsonk, fix, controller, selftests
...
- **核心贡献者**: Andy Yan (75条), Shawn Lin (32条), Damon Ding (25条), 等5人
...
主要技术关键词:
add, rockchip, support, dtbindings, drmrockchip
arm, dts, phy, vop, display
fix, drmbridge, analogixdp, enable, mmc
...
- **核心贡献者**: Qi Zheng (36条), Yunhui Cui (16条), Amery Hung (12条), 等5人
...
主要技术关键词:
pgtable, add, fix, riscv, use
bpf, introduce, tlbremovetable, schedfair, move
make, page, support, pagetabledtor, test
...
- **核心贡献者**: Kairui Song (73条), Jason Xing (26条), Jinliang Zheng (7条), 等5人
...
主要技术关键词:
swap, fix, use, cache, remove
net, mmshmem, cluster, allocation, xsk
helper, check, drop, folioindex, lock
...
- **核心贡献者**: WangYuli (45条), Cryolitia PukNgae (22条), Chen Linxuan (12条), 等5人
...
主要技术关键词:
fix, add, alsa, loongarch, typo
usbaudio, remove, error, notifer, docs
comment, hwmon, rename, missing, mips
...
- **核心贡献者**: Wang Yaxin (17条), Fan Yu (8条), Yumeng Fang (8条), 等5人
...
主要技术关键词:
use, docszhcn, translate, simplified, chinese
add, fix, helper, delay, delaytop
strtruefalse, replace, remove, taskstats, strreadwrite
...
- **核心贡献者**: Charles Han (32条), Chu Guangqing (20条), Bo Liu (20条), 等5人
...
主要技术关键词:
fix, convert, use, maple, tree
register, cache, iio, null, power
supply, inconsistent, typo, check, indenting
...
- **核心贡献者**: zhang jiao (20条), Zhang Chujun (10条), liujing (8条), 等5人
...
主要技术关键词:
fix, remove, unused, wrong, format
specifier, error, missing, spelling, errors
asoc, variable, typo, selftests, nethandshake
...
- **核心贡献者**: Yongpeng Yang (13条), pengdonglin (7条), Sheng Yong (7条), 等5人
...
主要技术关键词:
fix, ffs, add, remove, sbminblocksize
value, check, return, redundant, rcureadlockunlock
spinlock, devices, selinux, avoid, bio
...
- **核心贡献者**: Li RongQing (21条), Fushuai Wang (18条), Gao Shiyuan (2条), 等5人
...
主要技术关键词:
use, fix, remove, instead, foreachcpu
check, foreachonlinecpu, using, comment, kvm
rdmacore, redundant, memory, return, value
...
主要技术关键词:
avoid, invalid, usb, remove, value
add, replace, change, use, alarmtimer
comment, garbage, eth, fbnic, hpfs
...
主要技术关键词:
info, dmpcache, xsmpboot, spcr, pcache
fix, indexing, helper, ratelimit, log
smt, prevent, console, acpi, segment
...
- **核心贡献者**: Jos Wang (3条), Ziyan Fu (2条), Jiwei Sun (2条), 等4人
...
主要技术关键词:
timeout, fix, usb, typec, watchdog
itcowdt, pci, reading, link, update
memory, leak, tcpm, report, error
...
主要技术关键词:
dmthin, schedfair, fix, unfairness, caused
stalled, tgloadavgcontrib, last, task, migrates
set, dmtargetpassescrypto, feature, update, documentation
